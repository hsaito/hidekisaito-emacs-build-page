...
*** Linux (Experimental)
- [[file:emacs-24.3-linux-bin-x86_64-hs.tar.gz][Emacs binary tarball]] and its [[file:emacs-24.3-linux-bin-x86_64-hs.tar.gz.sig][signature file]] (for x86_64)
- x86 32-bit version coming soon.
...
*** Linux
Built and tested on Ubuntu 12.10 with Linux 3.5.0 kernel.
...
*** For Linux
Pretty much everything suppressing warning when ./configure is run without library supression arguments, such as no-gif.
...
*** Future plans
Currently, a build for [[http://www.raspberrypi.org/][Raspberry Pi]] is being considered.
